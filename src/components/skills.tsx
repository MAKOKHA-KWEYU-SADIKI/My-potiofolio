...
function Skills() {
        ...
        const skill=[
            {name:"SystemVehicle Hire Management ",img:img1,link:"https://car-hire-frontend-two.vercel.app/", desc:"This is an efficient web-based platform that streamlines the vehicle rental process, allowing users to easily browse available vehicles, make bookings, and manage rentals, offering a seamless and user-friendly experience for both customers and administrators."},
